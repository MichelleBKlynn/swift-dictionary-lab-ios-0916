...
if let anotherCapital = anotherCapital {
    print("Pennsylvania's capital is gr8!")
} else {
...
capital = statesAndCapitals["Pennsylvania"]
 ...
 */
let state = "New York"
capital = statesAndCapitals["New York"]
 ...
 */
let bandName = "Pixies"
var bandMembers = bandzMakeHerDance["Pixies"]

bandMembers = bandzMakeHerDance["Pixies"]
